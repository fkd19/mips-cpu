...
--               f:/test/project_1/project_1.srcs/sources_1/ip/ahblite_axi_bridge_0/ahblite_axi_bridge_0_sim_netlist.vhdl
...
architecture STRUCTURE of ahblite_axi_bridge_0_ahb_if is
  ...
  attribute SOFT_HLUTNM of \AXI_ALEN_i[1]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of S_AHB_HREADY_OUT_i_i_15 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of S_AHB_HREADY_OUT_i_i_18 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of S_AHB_HREADY_OUT_i_i_19 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of S_AHB_HREADY_OUT_i_i_9 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of S_AHB_HRESP_i_i_9 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of ahb_hburst_incr_i_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of ahb_hburst_single_i_i_2 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \valid_cnt_required_i[3]_i_2\ : label is "soft_lutpair6";
begin
...
architecture STRUCTURE of ahblite_axi_bridge_0_ahblite_axi_control is
  ...
  attribute SOFT_HLUTNM of M_AXI_AWVALID_i_i_1 : label is "soft_lutpair2";
...
architecture STRUCTURE of ahblite_axi_bridge_0_axi_rchannel is
  ...
  attribute SOFT_HLUTNM of M_AXI_RREADY_i_i_4 : label is "soft_lutpair13";
...
architecture STRUCTURE of ahblite_axi_bridge_0_counter_f is
  ...
  attribute SOFT_HLUTNM of \NARROW_TRANSFER_OFF.M_AXI_WSTRB_i[3]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of axi_last_beat_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of axi_last_beat_i_5 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of axi_last_beat_i_6 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of axi_penult_beat_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of axi_penult_beat_i_5 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of axi_penult_beat_i_6 : label is "soft_lutpair15";
...
architecture STRUCTURE of ahblite_axi_bridge_0_axi_wchannel is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \M_AXI_WDATA_i[15]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of ahb_data_valid_i_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \axi_cnt_required[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \axi_cnt_required[3]_i_1\ : label is "soft_lutpair20";
begin
...
M_AXI_WVALID_i_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \^m_axi_wvalid\,
      I1 => \dummy_on_axi__0\,
      I2 => ahb_data_valid_burst_term_reg_0,
      I3 => s_ahb_hresetn,
      I4 => m_axi_wready,
      I5 => \^m_axi_wlast\,
...
AHBLITE_AXI_CONTROL: entity work.ahblite_axi_bridge_0_ahblite_axi_control
     port map (
      ...
      \FSM_sequential_ctl_sm_cs_reg[1]_0\ => AHB_IF_n_16,
      \FSM_sequential_ctl_sm_cs_reg[1]_1\ => AHB_IF_n_17,
      M_AXI_ARVALID_i_reg => AHBLITE_AXI_CONTROL_n_10,
      M_AXI_ARVALID_i_reg_0 => \^m_axi_arvalid\,
      M_AXI_AWVALID_i_reg => AHBLITE_AXI_CONTROL_n_12,
      M_AXI_BREADY_i_reg => AHBLITE_AXI_CONTROL_n_19,
      \M_AXI_RREADY_i5__0\ => \M_AXI_RREADY_i5__0\,
      M_AXI_RREADY_i_reg => AHBLITE_AXI_CONTROL_n_6,
      M_AXI_WLAST_i_reg => AXI_WCHANNEL_n_7,
      M_AXI_WLAST_i_reg_0 => \^m_axi_wlast\,
      M_AXI_WVALID_i_reg => AHBLITE_AXI_CONTROL_n_9,
      ...
      S_AHB_HREADY_OUT_i_reg => AHBLITE_AXI_CONTROL_n_13,
      S_AHB_HREADY_OUT_i_reg_0 => \^s_ahb_hready_out\,
      S_AHB_HRESP_i_reg => AHBLITE_AXI_CONTROL_n_17,
      ahb_burst_done => ahb_burst_done,
      ...
      burst_term_hwrite_reg_0 => AHB_IF_n_20,
      burst_term_hwrite_reg_1 => AHB_IF_n_19,
      burst_term_i_reg => AHBLITE_AXI_CONTROL_n_16,
      burst_term_single_incr => burst_term_single_incr,
      ...
      ctl_sm_ns14_out => ctl_sm_ns14_out,
      idle_txfer_pending => idle_txfer_pending,
      idle_txfer_pending_reg => AHBLITE_AXI_CONTROL_n_14,
      idle_txfer_pending_reg_0 => AXI_RCHANNEL_n_3,
      idle_txfer_pending_reg_1 => AHB_IF_n_39,
      idle_txfer_pending_reg_2 => AHB_IF_n_14,
      idle_txfer_pending_reg_3 => AHB_IF_n_23,
      init_pending_txfer => init_pending_txfer,
      last_axi_rd_sample => last_axi_rd_sample,
      local_en => local_en,
      ...
      nonseq_detected => nonseq_detected,
      nonseq_txfer_pending => nonseq_txfer_pending,
      nonseq_txfer_pending_i_reg => AHBLITE_AXI_CONTROL_n_15,
      nonseq_txfer_pending_i_reg_0 => AHB_IF_n_21,
...
AHB_IF: entity work.ahblite_axi_bridge_0_ahb_if
     port map (
      ...
      E(0) => AHB_IF_n_29,
      \FSM_sequential_ctl_sm_cs_reg[1]\ => AHB_IF_n_21,
      \FSM_sequential_ctl_sm_cs_reg[2]\ => AHB_IF_n_23,
      ...
      M_AXI_ARVALID_i_reg => AHB_IF_n_20,
      ...
      SR(0) => cntr_rst,
      S_AHB_HREADY_OUT_i116_out => S_AHB_HREADY_OUT_i116_out,
      S_AHB_HREADY_OUT_i_reg_0 => AHB_IF_n_16,
      S_AHB_HREADY_OUT_i_reg_1 => AHB_IF_n_17,
      S_AHB_HREADY_OUT_i_reg_2 => AHB_IF_n_39,
      S_AHB_HREADY_OUT_i_reg_3 => AHBLITE_AXI_CONTROL_n_13,
      S_AHB_HRESP_i_reg_0 => AHB_IF_n_14,
      S_AHB_HRESP_i_reg_1 => AHBLITE_AXI_CONTROL_n_17,
      ahb_burst_done => ahb_burst_done,
      ahb_data_valid => ahb_data_valid,
      ahb_data_valid_burst_term => ahb_data_valid_burst_term,
      ahb_data_valid_burst_term_reg => AHB_IF_n_38,
      ahb_done_axi_in_progress => ahb_done_axi_in_progress,
      ahb_hburst_incr => ahb_hburst_incr,
      ahb_hburst_single => ahb_hburst_single,
      ahb_penult_beat_reg_0 => AHB_IF_n_3,
      ahb_wnr_i_reg => AHB_IF_n_19,
      axi_last_beat_reg(2 downto 0) => burst_term_txer_cnt(3 downto 1),
      axi_waddr_done_i => axi_waddr_done_i,
      burst_term => burst_term,
      burst_term_hwrite => burst_term_hwrite,
      burst_term_hwrite_reg_0 => AHBLITE_AXI_CONTROL_n_18,
      burst_term_i_reg_0 => AHBLITE_AXI_CONTROL_n_16,
      burst_term_single_incr => burst_term_single_incr,
      ...
      eqOp6_out => eqOp6_out,
      idle_txfer_pending => idle_txfer_pending,
      idle_txfer_pending_reg_0 => AHBLITE_AXI_CONTROL_n_14,
      init_pending_txfer => init_pending_txfer,
      ...
      nonseq_detected => nonseq_detected,
      nonseq_txfer_pending => nonseq_txfer_pending,
      nonseq_txfer_pending_i_reg_0 => AHBLITE_AXI_CONTROL_n_15,
      \out\(1) => AHBLITE_AXI_CONTROL_n_0,
      \out\(0) => AHBLITE_AXI_CONTROL_n_1,
      p_12_in => p_12_in,
      p_27_in => p_27_in,
...
AXI_RCHANNEL: entity work.ahblite_axi_bridge_0_axi_rchannel
     port map (
      \FSM_sequential_ctl_sm_cs_reg[2]\ => AHBLITE_AXI_CONTROL_n_6,
      M_AXI_ARVALID_i_reg_0 => AHBLITE_AXI_CONTROL_n_10,
      \M_AXI_RREADY_i5__0\ => \M_AXI_RREADY_i5__0\,
...
AXI_WCHANNEL: entity work.ahblite_axi_bridge_0_axi_wchannel
     port map (
      D(0) => AHBLITE_AXI_CONTROL_n_11,
      E(0) => AHBLITE_AXI_CONTROL_n_5,
      M_AXI_AWVALID_i_reg_0 => AHBLITE_AXI_CONTROL_n_12,
      M_AXI_WLAST_i110_out => M_AXI_WLAST_i110_out,
      ...
      ahb_data_valid => ahb_data_valid,
      ahb_data_valid_burst_term => ahb_data_valid_burst_term,
      ahb_data_valid_burst_term_reg_0 => AHBLITE_AXI_CONTROL_n_9,
      ...
      dummy_txfer_in_progress_reg => AHB_IF_n_12,
      eqOp6_out => eqOp6_out,
      local_en => local_en,
      m_axi_awvalid => \^m_axi_awvalid\,
      m_axi_bready => \^m_axi_bready\,
      ...
      m_axi_wstrb(0) => \^m_axi_wstrb\(2),
      m_axi_wvalid => \^m_axi_wvalid\,
      nonseq_txfer_pending_i_reg => AHB_IF_n_38,
      p_27_in => p_27_in,
      s_ahb_hclk => s_ahb_hclk,
      s_ahb_hresetn => s_ahb_hresetn,
...
entity ahblite_axi_bridge_0 is
  ...
  attribute x_core_info of ahblite_axi_bridge_0 : entity is "ahblite_axi_bridge,Vivado 2017.1";
